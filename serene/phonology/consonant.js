  ...
  static getMannerFromPlace (place, prng) {
    if (place === exports.PL_VELAR) {
      return prng.randElem([
        exports.MN_STOP,
        exports.MN_FRICATIVE,
        exports.MN_NASAL,
        exports.MN_APPROXIMANT,
        exports.MN_LATERAL_APPROXIMANT,
        exports.MN_LATERAL_FRICATIVE
      ])
      ...
      place === exports.PL_PHARYNGEAL ||
      place === exports.PL_EPIGLOTTAL
    ) {
...
exports.VOICING_NAMES = ['voiceless', 'voiced', 'aspirated']
